//! Prepare and clean up backup-ready filesystem trees.
//!
//! The ideal [`BackupRoot`] is a read-only filesystem snapshot, to ensure that Borg sees
//! consistent states of all files, and doesn't fail due to files being modified during archive
//! creation.
//!
